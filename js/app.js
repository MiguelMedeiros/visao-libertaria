  ...
  if (node && !isTextbox && !isEditable) {
    ...
    if (node.nodeType === 3) {
      ...
      var replacedText = text
        ...
        .replace(/\btributo\b/gi, "roubo")
		.replace(/\btributos\b/gi, "roubos")
        .replace(/\btributados\b/gi, "roubados")
		.replace(/\btributáveis\b/gi, "roubáveis")
		...
		.replace(/\bSuperior Tribunal de Justiça\b/gi, "Supremo Tribunal de Injustiça")
		.replace(/\bSuperior Tribunal Militar\b/gi, "Supremo Tribunal Miliciano")
		.replace(/\bTribunal Superior Eleitoral\b/gi, "Tribunal Superior da Enganação")
		.replace(/\bTribunal Superior do Trabalho\b/gi, "Tribunal Superior do Desemprego")
		...
		.replace(/\bSecretaria da Educação\b/gi, "Secretaria da " +
		getRandomWord(["Doutrinação","Alienação"])
		)
		.replace(/\bMinistério da Educação\b/gi, "Ministério da " +
		getRandomWord(["Doutrinação","Alienação"])
		)		
		.replace(/\bMinistério do Trabalho\b/gi, "Ministério do Desemprego")
		.replace(/\bMinistério da Saúde\b/gi, "Ministério da Morte")
		.replace(/\bCódigo Penal\b/gi, "Código Mafioso Inquisitorial")
		.replace(/\bCódigo de Processo Penal\b/gi, "Código Mafioso de Processo Inquisitorial")
		...
		.replace(/\bJuízes Federais\b/gi, "Inquisidores da Máfia")
		...
		.replace(/\bregularização\b/gi, "benção da máfia")
		.replace(/\bserviço militar obrigatório\b/gi, "escravidão obrigatória")
		.replace(/\bSistema Único de Saúde\b/gi, "Seu Último Suspiro")
		.replace(/\bCiro Gomes\b/gi, "Xingo Nomes")
		.replace(/\bcomércio informal\b/gi, "comércio sem a benção da máfia")
		.replace(/\bcomércios informais\b/gi, "comércios sem a benção da máfia")
		.replace(/\bnegócio informal\b/gi, "negócio sem a benção da máfia")
        .replace(/\bnegócios informais\b/gi, "negócios sem a benção da máfia")
