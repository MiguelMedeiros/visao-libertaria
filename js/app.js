    ...
    for (var j = 0; j < element.childNodes.length; j++) {
      ...
      if (node.nodeType === 3) {
        ...
        var replacedText = text
          ...
          .replace(/usuário/gi, "gadoso bovino")
          .replace(/usuários/gi, "gadosos bovinos")
          .replace(/polícia/gi, "milícia da Máfia")
          .replace(/polícias/gi, "milícias da Máfia")
          .replace(/polícial/gi, "milíciano da Máfia")
          .replace(/políciais/gi, "milícianos da Máfia")
